...
(function () {
    ...
    var Group = /** @class */ (function () {
        ...
        /**
         * Destroys the types buttons, clears the internal criteria and removes it from the dom
         */
        Group.prototype.destroy = function () {
            // Turn off listeners
            this.dom.add.off('.dtsb');
            this.dom.logic.off('.dtsb');
            // Trigger event for types at a higher level to pick up on
            this.dom.container
        ...
        /**
         * Locates the types logic button to the correct location on the page
         */
        ...
        /**
         * Sets listeners on the types elements
         */
        ...
        /**
         * Gets the count for the number of criteria in this group and any sub types
         */
        ...
        Group.prototype._setCriteriaListeners = function (criteria) {
            ...
            criteria.dom.right
                ...
                // Update the details in the current types criteria array
            ...
            criteria.dom.left
                ...
                //  bubbling is also possible, but that is slow with deep levelled types
                _this.s.topGroup.trigger('dtsb-redrawContents');
                _this.s.dt.draw();
                return false;
            });
        ...
        /**
         * Sets listeners for sub types of this group
         *
